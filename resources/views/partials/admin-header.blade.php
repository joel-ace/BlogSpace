            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img
                                                    src="{{ URL::to('assets/dist/img/user2-160x160.jpg') }}"
                                                    class="img-circle"
                                                    alt="User Image"
                                                >
                                            </div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img
                                                    src="{{ URL::to('assets/dist/img/user3-128x128.jpg') }}"
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img
                                                    src="{{ URL::to('assets/dist/img/user4-128x128.jpg') }}"
                                                    class="img-circle"
                                                    alt="User Image"
                                                >
                                            </div>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img
                                src="{{ URL::to('assets/dist/img/avatar.png') }}"
                                class="user-image"
                                alt="User Image"
                            >
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="?page=change-password" class="btn btn-default btn-flat"></i>
                                        Change Password
                                    </a>
                                </div>
